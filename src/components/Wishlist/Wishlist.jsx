...
export default function Wishlist() {
  ...
  let  {Getloggedwishlist,removeProductwishlist} = useContext (WishlistContext);
...
async  function getCartwishlist(){
 ...
 <tr  key={product.id } className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
        ...
        <td className="px-6 py-4">
          <span onClick={()=>deletItem(product?.id)}
    ...
    </> :<h1 className='capitaliz text-center text-emerald-600 font-bold text-3xl my-10' >There Is No Item To Show</h1>   }
